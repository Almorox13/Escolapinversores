...
public class VentaAcciones extends JFrame{
	/*
	...
	public VentaAcciones() {
		...
		JLabel lblNewLabel = new JLabel("ID de la accion que desea vender");
		lblNewLabel.setBounds(66, 127, 385, 40);
		lblNewLabel.setForeground(new Color(0, 102, 153));
		lblNewLabel.setFont(new Font("Calibri", Font.BOLD, 20));

		JLabel lblNewLabel_1 = new JLabel("Numero de acciones a vender");
		...
		JLabel lblNewLabel_2 = new JLabel("Venta de Acciones");
		lblNewLabel_2.setBounds(325, 22, 253, 38);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				fin = false;
				coordinador.ocultarVentanaVentaAcciones();
	...
	private class porLoMejor implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			caja_id_accion.setValue(coordinador.consultaVenta());
		}
	}
	...
	private class confirmar implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			int confirmacion = JOptionPane.showConfirmDialog(null, "¿Confirmar petición de venta?", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
			if(confirmacion == 0){
