...
public class HistorialOperador extends JFrame {
	...
	public HistorialOperador() {
		...
		lblNewLabel_7.setBounds(187, 732, 65, 31);
		...
		caja_fecha.setBounds(246, 728, 182, 39);
		...
		caja_idcliente.setFont(new Font("Calibri", Font.BOLD, 18));
		...
		JLabel lblNewLabel_9 = new JLabel("ID cuenta");
		lblNewLabel_9.setForeground(new Color(0, 102, 153));
		lblNewLabel_9.setFont(new Font("Calibri", Font.BOLD, 20));
		lblNewLabel_9.setBounds(181, 685, 101, 36);
		contentPane.add(lblNewLabel_9);

		caja_idcliente.setBounds(276, 689, 111, 27);
